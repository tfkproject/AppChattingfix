...
public class ChatRoomActivity extends AppCompatActivity {
    ...
    private ImageButton mChatgaleriBtn;
    private ImageButton mChatcameraBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChatgaleriBtn = (ImageButton) findViewById(R.id.chat_galeri);
        mChatcameraBtn = (ImageButton) findViewById(R.id.chat_camera);
...
//                                .placeholder(R.drawable.picture).into(mProfileImage);
//                    }
        ...
        mRootRef.child("Chat").child(mCurrentUserId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.hasChild(mChatUser)) {
                    ...
                    chatUserMap.put(mChatMessageView.getText() + "/" + mCurrentUserId + "/" + mChatUser, chatAddMap);
                    chatUserMap.put(mChatMessageView.getText() + "/" + mChatUser + "/" + mCurrentUserId, chatAddMap);
